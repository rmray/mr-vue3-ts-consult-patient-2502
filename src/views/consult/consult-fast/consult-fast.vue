...
<template>
  <div class="consult-fast">
    ...
    <div class="fast-type">
      <router-link to="/consult/department" class="item" @click="consultStore.setIllnessType(1)">
      ...
      <router-link to="/consult/department" class="item" @click="consultStore.setIllnessType(0)">
